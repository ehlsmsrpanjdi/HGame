...
struct Z_Construct_UClass_ARTS_InterfacePlayerController_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ARTS_InterfacePlayerController_GetMousePos, "GetMousePos" }, // 1578688675
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARTS_InterfacePlayerController_Statics::NewProp_Input_mc = { "Input_mc", nullptr, (EPropertyFlags)0x0124080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARTS_InterfacePlayerController, Input_mc), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Input_mc_MetaData), NewProp_Input_mc_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARTS_InterfacePlayerController_Statics::NewProp_Input_WheelUp = { "Input_WheelUp", nullptr, (EPropertyFlags)0x0124080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARTS_InterfacePlayerController, Input_WheelUp), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Input_WheelUp_MetaData), NewProp_Input_WheelUp_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARTS_InterfacePlayerController_Statics::NewProp_Input_WheelDown = { "Input_WheelDown", nullptr, (EPropertyFlags)0x0124080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARTS_InterfacePlayerController, Input_WheelDown), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Input_WheelDown_MetaData), NewProp_Input_WheelDown_MetaData) };
...
struct Z_CompiledInDeferFile_FID_RTS_Interface_Source_RTS_Interface_RTS_InterfacePlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARTS_InterfacePlayerController, ARTS_InterfacePlayerController::StaticClass, TEXT("ARTS_InterfacePlayerController"), &Z_Registration_Info_UClass_ARTS_InterfacePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARTS_InterfacePlayerController), 1515905609U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RTS_Interface_Source_RTS_Interface_RTS_InterfacePlayerController_h_75798635(TEXT("/Script/RTS_Interface"),
